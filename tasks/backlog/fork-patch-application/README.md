...
**Estimated effort**: ~230 minutes (≈4 hours focused work)
...
2. **Commit 2** — Patch 006 factories.py auto-detect + clean Neo4j config template (bug #6/#7, captured from Mac via rsync over Tailscale)
...
| [TASK-FPA-002](TASK-FPA-002-push-fork-to-github.md) | Rename branch and push to origin (`guardkit/graphiti`) | 1 | direct | 10 |
| [TASK-FPA-003](TASK-FPA-003-apply-redisearch-sanitize-mcp-host-patches.md) | Apply patches 001+002+003 (commit 1) | 2 | direct | 30 |
| [TASK-FPA-004](TASK-FPA-004-apply-factories-auto-detect.md) | Apply patch 006 factories.py auto-detect (commit 2) | 2 | direct | 20 |
